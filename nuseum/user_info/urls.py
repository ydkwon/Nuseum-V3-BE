...
urlpatterns = [
    ...
    path('api/v1/allergy_post', views.Allergy_Post.as_view(), name='affliction_post'), # 사용자 알러지 리스트 Post    
    path('api/v1/allergy_get', views.Allergy_Get.as_view(), name='affliction_get'), # 사용자 알러지 리스트 Get
]