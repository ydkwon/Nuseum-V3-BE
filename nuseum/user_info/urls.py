...
urlpatterns = [
    ...
    path('api/v1/incongruity_post', views.Incongruity_Post.as_view(), name='incongruity_post'), # 사용자 부정영향 리스트 Post    
    path('api/v1/incongruity_get', views.Incongruity_Get.as_view(), name='incongruity_get'), # 사용자 부정영향 리스트 Get
    path('api/v1/allergy_post', views.Allergy_Post.as_view(), name='incongruity_post'), # 사용자 알러지 리스트 Post    
    path('api/v1/allergy_get', views.Allergy_Get.as_view(), name='incongruity_get'), # 사용자 알러지 리스트 Get
]