...
urlpatterns = [
    ...
    path('api/v1/user_recommend_product/', views.User_Recommend_ProductList.as_view(), name='user_recommend_product'), # 사용자 주문 시 해당 food 사용 체크
    path('api/v1/food_use_set/', views.Food_Use_Set.as_view(), name='food_use_set'), # 사용자 주문 시 해당 food 사용 체크
